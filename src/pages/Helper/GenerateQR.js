    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Typography variant='h6' component='h1'>
          <i className='uil uil-qrcode-scan' /> Générateur d'attestation de
        ...
        <Typography color='textSecondary'>
          ...
          Covid19 dans le cadre de l’état d’urgence sanitaire. (Générateur créer
          avant le gouvernement français le 04/05/2020)
        </Typography>
        ...
        <Box style={{ marginTop: 15 }}>
              ...
              >
                ...
                >
                  ...
                  <option value='courses'>
                    Déplacements pour effectuer des achats de fournitures
                    nécessaires à lactivité professionnelle et des achats de
                    première nécessité.
                  </option>
                  <option value='sante'>
                    Consultations et soins ne pouvant être assurés à distance et
                    ne pouvant être différés.
                  </option>
                  <option value='famille'>
                    Déplacements pour motif familial impérieux, pour
                    l’assistance aux personnes vulnérables ou la garde
                    d’enfants.
                  </option>
                  <option value='sport'>
                    Déplacements brefs, dans la limite d'une heure quotidienne
                    et dans un rayon maximal d'un kilomètre autour du domicile.
                  </option>
                  <option value='judiciaire'>
                    Convocation judiciaire ou administrative.
                  </option>
                  <option value='missions'>
                    Participation à des missions d’intérêt général sur demande
                    de l’autorité administrative.
                  </option>
                </Select>
                <FormHelperText>
                  Veuillez sélectionner un modif de sortie
                </FormHelperText>
              </FormControl>
            </Box>
          </Box>
          ...
          <Dialog open={open} onClose={handleClose}>
            ...
            <DialogContent>
              <DialogContentText>
                Avant de télécharger l'attestation veuillez à bien vérifier les
                informations que vous avez renseigné.
              </DialogContentText>
              <DialogContentText>
                Si vous avez un doute sur la véracité de ce générateur
                d'attestation de déplacement provisoire vous pouvez vous rendre
                sur{" "}
                <a
