    ...
    <div className={classes.root}>
      ...
      <main className={classes.content}>
        ...
        <Typography variant='h6' component='h1'>
          <i className='uil uil-user-location' /> Tous les utilisateurs de
          l'application
        </Typography>
        <Typography color='textSecondary'>
          Affichage en temps réel de tous les utilisateurs de l'application
          répartie sur une carte interactive
        </Typography>
