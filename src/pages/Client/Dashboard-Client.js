				...
				<Box style={{ height: '80vh' }} display='flex' alignItems='center' justifyContent='center'>
					<Box>
						...
						<Box style={{ marginTop: 25 }} display='flex' alignItems='center'>
							...
							>
								<Link to={ROUTE.DASHBOARD_QUESTIONS} style={{ textDecoration: 'none', width: '100%' }}>
						...
						<Box display='flex' alignItems='center'>
							...
							>
								<Link to={ROUTE.DASHBOARD_HISTORY} style={{ textDecoration: 'none', width: '100%' }}>
									<Box
										display='flex'
										justify='center'
										alignItems='center'
							...
							>
								<Link to={ROUTE.DASHBOARD_CONTACT} style={{ textDecoration: 'none', width: '100%' }}>
									<Box display='flex' justify='center' alignItems='center' style={{ height: '100%' }}>
										<Typography
											style={{ fontWeight: 'bold', color: '#1f2d3d', opacity: 0.9 }}
											variant='h6'
